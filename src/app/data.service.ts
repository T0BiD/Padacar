...
export class DataService {
  ...
  constructor() {
    ...
    let f1 = new Fahrt(p1);
    f1.start = "paderborn";f1.ziel = "München";f1.datum=new Date("12.01.2018");f1.id = this.angeboteneFahrten.length++;f1.maxmitfahrer = 4;
    ...
    let f2 = new Fahrt(p2);
    f2.start = "paderborn";f2.ziel = "München";f2.datum=new Date("01.31.2018");f2.id = this.angeboteneFahrten.length++;f2.maxmitfahrer = 4;
    ...
    let f3 = new Fahrt(p3);
    f3.start = "paderborn";f3.ziel = "München";f3.datum=new Date("02.02.2017");f3.id = this.angeboteneFahrten.length++;f3.maxmitfahrer = 4;
